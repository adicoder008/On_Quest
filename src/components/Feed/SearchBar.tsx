...
export const SearchBar = () => {
  ...
  return (
    <div className="box-border flex items-center w-[361px] border shadow-[4px_4px_10px_rgba(0,0,0,0.1)] bg-white pl-2.5 pr-1.5 py-2.5 rounded-[32px] border-solid border-[#8B8A8F] max-sm:w-full max-sm:max-w-[300px]">
      <svg
      ...
      />
      <button className="box-border text-white cursor-pointer bg-[#EA6100] px-4 py-2.5 rounded-[32px] border-none">
        Search
      </button>
    </div>
  );
