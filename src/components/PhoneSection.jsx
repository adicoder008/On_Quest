    ...
    <>
     <div className='bg-[#F86F0A] py-10 px-4 bg-opacity-10 '>
      ...
      <div className='flex flex-col justify-centre items-center xs:flex-row pl-14 '>
            <div><img className=' rounded-xl' src="On_Quest/phone1.svg" alt="" /></div>
            <div><img className=' rounded-xl translate-y-16 ' src="On_Quest/phone4.svg" alt="" /></div>
            <div><img className=' rounded-xl' src="On_Quest/phone3.svg" alt="" /></div>    
      </div>
      </div>
    </>
  )
