...
export const TripHeader = () => {
  return (
    <div className="flex items-center font-normal justify-between flex-wrap mt-[23px] px-8 max-md:px-5">
      <div className="self-stretch flex min-w-60 flex-col items-stretch flex-1 shrink basis-[0%] my-auto max-md:max-w-full">
        ...
        <p className="gap-2 text-base text-black text-center mt-4 max-md:max-w-full">
