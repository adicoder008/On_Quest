...
const HowItWorks = () => {
  return (
    <>
    <div className='bg-[#FFFFFF] py-20 pb-24 px-4 bg-opacity-10 '>
      ...
      <div className='flex flex-col justify-center items-center gap-6 xs:flex-row'>
        <div className='flex-1 flex flex-col shadow-xl min-h-[30vh] max-h-[70vh] bg-[#F86F0A] rounded-xl bg-opacity-10 gap-3'>
        ...
        <div className='flex-1 flex flex-col shadow-xl min-h-[30vh] max-h-[70vh] bg-[#F86F0A] rounded-xl bg-opacity-10 gap-3 sm:w-[27vw]'>
